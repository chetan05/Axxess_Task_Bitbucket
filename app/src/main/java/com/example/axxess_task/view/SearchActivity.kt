...
import com.example.axxess_task.R
import com.example.axxess_task.Util.SEARCH_ITEM_DETAILS
import com.example.axxess_task.model.SearchItemDetailsResponse
import com.example.axxess_task.model.SearchResultResponse
import com.example.axxess_task.viewmodel.Fail
...
class SearchActivity(override val coroutineContext: CoroutineContext = Dispatchers.Main) :
    ...
    private fun determineSearchCriteria() {
        ...
        if (query.isEmpty()) {
            ...
            searchViewModel.loadReservation(query)
